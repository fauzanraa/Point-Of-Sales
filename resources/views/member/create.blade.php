...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        <form method="POST" action="{{ url('member') }}" class="form-horizontal">
        @csrf
        ...
        <div class="form-group row">
            ...
            value="{{ old('alamat_member') }}" required>
            @error('alamat_member')
            <small class="form-text text-danger">{{ $message }}</small>
            @enderror
            </div>
        ...
        <div class="col-11">
            ...
            <a class="btn btn-sm btn-default ml-1" href="{{ url('member') 
            }}">Kembali</a>
        </div>
        </div>
        </form>
