  ...
  <div class="card-body">
    ...
    <form method="POST" action="{{ url('/stok/'.$stok->stok_id) }}" class="form-horizontal">
      ...
      <div class="form-group row">
        ...
        <div class="col-11">
          <input type="date" class="form-control" id="stok_tanggal" name="stok_tanggal" disabled
            value="{{ $tanggal }}">
          @error('stok_tanggal')
          <small class="form-text text-danger">{{ $message }}</small>
          @enderror
          <small class="form-text text-muted">Tanggal otomastis di set ke hari ini</small>
        </div>
      </div>
      <div class="form-group row">
